...
namespace tsl {
    namespace elm {
        ...
        u32 MiniListItem2DefaultHeight = 57;

        /**
         * @brief A item that goes into a list
         *
         */
        class MiniListItem2 : public Element {
        public:
            /**
             * @brief Constructor
             *
             ...
             */
            MiniListItem2(const std::string& text, const std::string& value = "")
                : Element(), m_text(text), m_value(value) {
            }
            virtual ~MiniListItem2() {}
            ...
            virtual void draw(gfx::Renderer *renderer) override {
                ...
                if (this->m_trunctuated) {
                    if (this->m_focused) {
                        ...
                        renderer->drawString(this->m_scrollText.c_str(), false, this->getX() + 20 - this->m_scrollOffset, this->getY() + 37, 23, tsl::style::color::ColorText);
                        ...
                        renderer->drawString(this->m_ellipsisText.c_str(), false, this->getX() + 20, this->getY() + 37, 23, a(tsl::style::color::ColorText));
                    }
                } else {
                    renderer->drawString(this->m_text.c_str(), false, this->getX() + 20, this->getY() + 37, 23, a(tsl::style::color::ColorText));
                }

                renderer->drawString(this->m_value.c_str(), false, this->getX() + this->m_maxWidth + 45, this->getY() + 37, 20, this->m_faint ? a(tsl::style::color::ColorDescription) : a(tsl::style::color::ColorHighlight));
            }

            virtual void layout(u16 parentX, u16 parentY, u16 parentWidth, u16 parentHeight) override {
                this->setBoundaries(this->getX(), this->getY(), this->getWidth(), MiniListItem2DefaultHeight);
            }
            ...
            virtual void drawHighlight(gfx::Renderer *renderer) override {
                ...
                renderer->drawString("▶", false, this->getX() + x, this->getY() + y + 37, 20, a(highlightColor));
